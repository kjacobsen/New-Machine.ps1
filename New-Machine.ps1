...
& 'C:\Program Files (x86)\EMET 5.5\EMET_Conf.exe' --system --force DEP=AlwaysON SEHOP=AlwaysON ASLR=ApplicationOptIN Pinning=Enabled
& 'C:\Program Files (x86)\EMET 5.5\EMET_Conf.exe' --import 'C:\Program Files (x86)\EMET 5.5\Deployment\Protection Profiles\CertTrust.xml'
& 'C:\Program Files (x86)\EMET 5.5\EMET_Conf.exe' --import 'C:\Program Files (x86)\EMET 5.5\Deployment\Protection Profiles\Popular Software.xml'
& 'C:\Program Files (x86)\EMET 5.5\EMET_Conf.exe' --import 'C:\Program Files (x86)\EMET 5.5\Deployment\Protection Profiles\Recommended Software.xml'
